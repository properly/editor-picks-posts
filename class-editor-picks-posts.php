...
/**
 * Editor Picks Posts Plugin class.
 *
 * @package Editor_Picks_Posts
 */
class Editor_Picks_Posts
{
    /**
     ...
     * @var      string
     */
    protected $plugin_slug = 'editor-picks-posts';
    ...
    private static function single_activate()
    {
        ...
        $option_name = 'epp_plugin_options';
    ...
    {
		$epp_options = array_merge( self :: $default_options , (array) get_option( 'epp_plugin_options', array() ) );
        $this->options = $epp_options;
    }

	//get default options and saves in options table
    private function _setDefaultOptions()
    {
        if( !get_option( 'epp_plugin_options' ) ) {
            update_option('epp_plugin_options', self :: $default_options);
        }
    }
	...
	public function editor_picks_posts_get_options_array(){
		return $this->options;
	}
